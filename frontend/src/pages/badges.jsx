...
export default function BadgesPage() {
  ...
  return (
    <div className="min-h-screen pt-12 flex flex-col items-center bg-gradient-to-br from-[#18181b] via-[#23272f] to-[#101014] text-white font-sans p-6">
      <div className="w-full max-w-5xl mx-auto mt-8 bg-[#232526] border border-gray-700 rounded-2xl shadow-2xl p-8 animate-fade-in">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link to="/profile" className="text-blue-400 hover:underline font-medium text-base">
            Back to Profile
          </Link>
        </div>
