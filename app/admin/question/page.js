...
import { updateQuestion } from "@/app/services/updateQuestion";
...
export default function QuestionForm() {
    ...
    const [form, setForm] = useState({
        ...
        correct_ans: questionData.correct_ans || "",
    ...
    useEffect(() => {
        if (questionData && questionId) {
            setForm({
                ...
                question_text: questionData.question_text || "",
                correct_ans: questionData.correct_ans || "",
                difficulty: questionData.difficulty || difficultyOptions[0].name,
            });
        }
    }, [questionData,lessonId, questionId]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (error) {
            ...
            alert("question is been updated")
        }
    };
