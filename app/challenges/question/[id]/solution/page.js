...
export default function SolutionPage() {
  ...
  const getDifficultyIcon = (difficulty) => {
    switch (difficulty) {
      ...
      case "Hard":
        return <Star className="w-6 h-6 text-red-400" />;
      default:
        ...
        <div className="bg-gradient-to-br from-neutral-900/90 to-neutral-800/90 border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
            <div className="flex items-center gap-6">
              <div className="p-3 bg-purple-600 rounded-xl shadow-md hover:bg-purple-700 transition-colors">
                <Code className="w-8 h-8 text-white" />
              </div>
              <div>
                <h1 className="text-4xl font-bold text-white mb-2">Solution - {question.title}</h1>
                <p className="text-gray-300">{question.short_description || "See the solution for this challenge."}</p>
              </div>
            </div>
          ...
          <div className="mb-10">
            ...
            <p className="text-lg text-gray-200 leading-relaxed">
              {question.solution || "No solution provided yet."}
            </p>
          </div>

          {/* Skills Used */}
          <div className="mb-10">
            <h3 className="text-xl font-semibold text-white mb-3">Skills Used</h3>
